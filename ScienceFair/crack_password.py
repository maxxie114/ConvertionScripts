...
def main(argv=None):
    ...
    password1=MD5me("1141611")
    password2=MD5me("max1141611")
    password3=MD5me("password135")
    password4=MD5me("complicated")
    password5=MD5me("Zs_Max@111141611")
    password6=MD5me("MmIydG1jcGV2cHN1YnVudHUxMjM")
